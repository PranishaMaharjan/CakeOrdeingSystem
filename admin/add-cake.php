        ...
        <div class="form-box">
          <div class="login-container" id="login">
            ...
            <form action="" method="POST"  enctype="multipart/form-data">
              ...
              <div class="input-box">
                <input type="file" class="input-field" name="image" placeholder="Image" />
              </div>
              <div class="input-box">
                <input
                  type="text"
...
<td>
 <a href="add-cake.php?delete=<?php echo $row['cakeFlavour']; ?>" class="delete-btn" onclick="return confirm('Are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
